...
namespace TempleVolunteerClient.Controllers
{
    public class StaffController : CustomController
    {
        ...
        //            viewModel = _mapper.Map<StaffViewModel>(JsonConvert.DeserializeObject<Staff>(staff.Data.ToString()));
        ...
        //            var staff = JsonConvert.DeserializeObject<ServiceResponse>(response.Content.ReadAsStringAsync().Result);
        //            StaffViewModel viewModel = _mapper.Map<StaffViewModel>(JsonConvert.DeserializeObject<Staff>(staff.Data.ToString()));
                    
        //            return _mapper.Map<Staff>(viewModel);
        //        }
        //    }
        //    catch
        //    {
        ...
        //                    if (updateImage)
        //                    {
        //                        staff.StaffFileName = viewModel.StaffImageFile.FileName;
        ...
        //            return Json(
        //                new { data = JsonConvert.DeserializeObject<List<Staff>>(data.Data.ToString()) }
        //            );
        //        }
        //    }
        //    catch (Exception ex)
        ...
        //            string stringData = response.Content.ReadAsStringAsync().Result;
        //            ServiceResponse data = JsonConvert.DeserializeAnonymousType<ServiceResponse>(stringData, new ServiceResponse());
        //            var json = Json(new { data = JsonConvert.DeserializeObject<Staff>(data.Data.ToString()) });

        //            return Json(
        //                new { data = JsonConvert.DeserializeObject<Staff>(data.Data.ToString()) }
        //            );
        //        }
        //    }
        //    catch (Exception ex)
