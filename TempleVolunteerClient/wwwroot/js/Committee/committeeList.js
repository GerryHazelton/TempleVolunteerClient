...
function loadDataTable() {
    dataTable = $('#committeeTable').DataTable({
        "ajax": {
            ...
            "serverSide": false,
            "error": function () {
                window.location.href = "/Account/CommitteeModalPopUp"; 
            }
        },
        "columns": [
            { "data": "name", "width": "10%" },
            { "data": "description", "width": "10%" },
            {
                ...
                "render": function (data) {
                    return `<div class="text-center">
                                ...
                                <a href="/Committee/CommitteeUpsert?committeeId=${data}">
                                    <img class='img-75' src="/img/edit.png" alt="Edit Committee" />
                                </a>
                                <a href=# onclick=Delete('/Committee/CommitteeDelete?committeeId='+${data})>
